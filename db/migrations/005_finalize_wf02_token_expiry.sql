...
CREATE OR REPLACE FUNCTION finalize_wf02_token_expiry(
    p_operation_id uuid,
    p_case_id uuid,
    p_token_id uuid,
...
COMMENT ON FUNCTION finalize_wf02_token_expiry(
    uuid,
    uuid,
    uuid,
    text,
...
IS
'Atomically finalizes a WF02 token that expired before confirmed delivery.';
